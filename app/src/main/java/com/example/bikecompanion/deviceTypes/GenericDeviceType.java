...
public class GenericDeviceType {
    ...
    public final static UUID UUID_CHARACTERISTIC_MANUFACTURER = UUID.fromString(STRING_CHARACTERISTIC_MANUFACTURER);
    ...
    // Model UUIDs
    public static final String STRING_SERVICE_MODEL = "0000180a-0000-1000-8000-00805f9b34fb";
    public static final String STRING_CHARACTERISTIC_MODEL = "00002a24-0000-1000-8000-00805f9b34fb";
    public final static UUID UUID_SERVICE_MODEL = UUID.fromString(STRING_SERVICE_MODEL);
    public final static UUID UUID_CHARACTERISTIC_MODEL = UUID.fromString(STRING_CHARACTERISTIC_MODEL);
